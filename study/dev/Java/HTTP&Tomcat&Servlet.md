...
![image-20230108144249832](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108144249832.png)
...
* 前端网页制作`三剑客`(HTML+CSS+JavaScript),使用这些技术我们就可以制作出效果比较丰富的网页，将来展现给用户。但是由于做出来的这些内容都是静态的，这就会导致所有的人看到的内容将是一模一样。
...
* 数据库主要负责存储数据。
* 整个Web的访问过程就如下图所示:
  ![image-20230108144638037](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108144638037.png)
...
![image-20230108144934522](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108144934522.png)
...
* 请求体: POST请求的最后一部分，存储请求参数
  ...
  ![image-20230108144951595](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108144951595.png)
...
![image-20230108145212720](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108145212720.png)
...
上面代码，不需要自己写，主要通过上述代码，了解到服务器可以使用java完成编写，是可以接受页面发送的请求和响应数据给前端浏览器的，真正用到的Web服务器，我们不会自己写，都是使用目前比较流行的web服务器，比如==Tomcat==
...
![image-20230108145450096](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108145450096.png)
...
![image-20230108145519175](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108145519175.png)
...
![image-20230108145545345](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108145545345.png)
...
![image-20230108150044699](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150044699.png)
...
* 打开`apache-tomcat-8.5.68`目录就能看到如下目录结构，每个目录中包含的内容需要认识下,
  ...
  ![image-20230108150117472](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150117472.png)
...
![image-20230108150217614](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150217614.png)

启动后，通过浏览器访问 `http://localhost:8080`能看到Apache Tomcat的内容就说明Tomcat已经启动成功。

![image-20230108150232173](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150232173.png)

==注意==: 启动的过程中，控制台有中文乱码，需要修改conf/logging.prooperties

![image-20230108150244433](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150244433.png)
...
![image-20230108150334418](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150334418.png)
...
* Tomcat的端口号取值范围是0-65535之间任意未被占用的端口，如果设置的端口号被占用，启动的时候就会包如下的错误
  ...
  ![image-20230108150353372](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150353372.png)

* Tomcat启动的时候，启动窗口一闪而过: 需要检查JAVA_HOME环境变量是否正确配置

![image-20230108150408259](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150408259.png)
...
* Tomcat部署项目： 将项目放置到webapps目录下，即部署完成。
  ...
  * 通过浏览器访问`http://localhost/hello/a.html`，能看到下面的内容就说明项目已经部署成功。
    ...
    ![image-20230108150454876](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108150454876.png)
...
* 一般JavaWeb项目会被打包称==war==包，然后将war包放到Webapps目录下，Tomcat会自动解压缩war文件
  ...
  * 通过浏览器访问`http://localhost/haha/a.html`，能看到下面的内容就说明项目已经部署成功。
    ...
    ![image-20230108151424967](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108151424967.png)
...
在真正创建Maven Web项目之前，要知道Web项目长什么样子，具体的结构是什么?
...
* Maven Web项目结构: 开发中的项目
  ...
  ![image-20230108151626111](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108151626111.png)

* 开发完成部署的Web项目

  ![image-20230108151646663](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108151646663.png)
...
1. 创建Maven项目
   ...
   ![image-20230108152042995](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152042995.png)

2. 选择使用Web项目骨架

   ![image-20230108152139802](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152139802.png)

3. 输入Maven项目坐标创建项目

   ![image-20230108152203997](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152203997.png)

4. 确认Maven相关的配置信息后，完成项目创建

   ![image-20230108152217733](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152217733.png)

5. 删除pom.xml中多余内容，只留下面的这些内容，注意打包方式 jar和war的区别

   ![image-20230108152240302](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152240302.png)

6. 补齐Maven Web项目缺失的目录结构，默认没有java和resources目录，需要手动完成创建补齐，最终的目录结果如下

   ![image-20230108152301763](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152301763.png)
...
1. 创建Maven项目
   ...
   ![image-20230108152342081](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152342081.png)

2. 选择不使用Web项目骨架

   ![image-20230108152440857](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152440857.png)

3. 输入Maven项目坐标创建项目

   ![image-20230108152455636](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152455636.png)

4. 在pom.xml设置打包方式为war,默认是不写代表打包方式为jar

   ![image-20230108152509541](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152509541.png)

5. 补齐Maven Web项目缺失webapp的目录结构

   ![image-20230108152528178](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108152528178.png)

6. 补齐Maven Web项目缺失WEB-INF/web.xml的目录结构

   ![image-20230108153419467](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108153419467.png)

7. 补充完后，最终的项目结构如下:

   ![image-20230108153437286](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108153437286.png)
...
![image-20230108153519318](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108153519318.png)

> 3.掌握不使用骨架的方式创建Maven Web项目

![image-20230108155832634](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108155832634.png)
...
1. 打开添加本地Tomcat的面板
   ...
   ![image-20230108155848017](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108155848017.png)

2. 指定本地Tomcat的具体路径

   ![image-20230108155901986](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108155901986.png)

3. 修改Tomcat的名称，此步骤可以不改，只是让名字看起来更有意义，HTTP port中的端口也可以进行修改，比如把8080改成80

   ![image-20230108155927716](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108155927716.png)

4. 将开发项目部署项目到Tomcat中

   ![image-20230108155956426](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108155956426.png)
...
5. 部署成功后，就可以启动项目，为了能更好的看到启动的效果，可以在webapp目录下添加a.html页面
   ...
   ![image-20230108161710959](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108161710959.png)

6. 启动成功后，可以通过浏览器进行访问测试

   ![image-20230108161722159](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108161722159.png)

7. 最终的注意事项

   ![image-20230108161727726](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108161727726.png)

   

至此，IDEA中集成本地Tomcat进行项目部署的内容就完了，整体步骤如下，大家需要按照流程进行部署操作练习。

![image-20230108161759009](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108161759009.png)
...
![image-20230108161959352](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108161959352.png)

==注意:==

* 如果选中项目并右键点击后，看不到Run Maven和Debug Maven，这个时候就需要在IDEA中下载Maven Helper插件，具体的操作方式为: File --> Settings --> Plugins --> Maven Helper ---> Install,安装完后按照提示重启IDEA，就可以看到了。

![image-20230108162103310](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162103310.png)
...
![image-20230108162220886](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162220886.png)
...
* Servlet是JavaEE规范之一，其实就是一个接口，将来我们需要定义Servlet类实现Servlet接口，并由web服务器运行Servlet
  ...
  ![image-20230108162234909](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162234909.png)

介绍完Servlet是什么以后，接下来就按照`快速入门`->`执行流程`->`生命周期`->`体系结构`->`urlPattern配置`->`XML配置`的学习步骤，一步步完成对Servlet的知识学习，首选我们来通过一个入门案例来快速把Servlet用起来。
...
![image-20230108162400294](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162400294.png)
...
* 通过案例演示下上述的生命周期
  ...
  */
  ...
  ![image-20230108162735352](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162735352.png)
...
![image-20230108162449157](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162449157.png)
...
* 一个Servlet,可以配置多个urlPattern
  ...
  ![image-20230108162512618](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162512618.png)
...
* ==urlPattern配置规则==
  ...
  * 精确匹配
    ...
    ![image-20230108162534440](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162534440.png)
  ...
  * 目录匹配
    ...
    ![image-20230108162546195](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162546195.png)
  ...
  * 扩展名匹配
    ...
    ![image-20230108162557248](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162557248.png)
    ...
    ![image-20230108162608464](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162608464.png)

    2. 如果路径配置的是`*.do`,那么在*.do的前面不能加`/`,否则会报错

    ![image-20230108162615602](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162615602.png)

  * 任意匹配

    ![image-20230108162622139](https://raw.githubusercontent.com/levanaya/web-img/main/img/image-20230108162622139.png)
