...
![image-20221015161053574](https://cdn.jsdelivr.net/gh/levanaya/web-img@main/img/20221015161053.png)
...
![image-20221015161805948](https://cdn.jsdelivr.net/gh/levanaya/web-img@main/img/20221015161806.png)
...
只能存储字符串，可以将对象JSON.stringfy()编码后进行存储

**不同点：**

存储大小限制不同

数据有效期不同：localStorage：始终有效，sessionStorage：当前浏览器窗口关闭前有效
...
alt属性是当元素不能正常呈现时用作元素的代替文本，title属性是将鼠标悬停在元素上时看到的工具提示文本，是对图片的描述和进一步的说明。
